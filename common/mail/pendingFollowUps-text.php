...
/* @var $followUp[] common\models\FollowUp */
/* @var $link String */
/* @var $total int */
?>
<div class='followup-reminder'>
	...
	<p>You have total <strong><?= $total ?></strong> pending follow ups.</p>
					...
					<tr>
						<td style="padding: .35rem 0.5rem !important; border-color: #e4e4e4; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd;">
							<div style="height: 15px; width: 5px; <?php 
								if($followUp->inquiry->inquiry_priority == 1) {
									echo 'background-color: #DD6777;';
								} elseif ($followUp->inquiry->inquiry_priority == 2) {
									echo 'background-color: #6164C1;';
								} elseif ($followUp->inquiry->inquiry_priority == 3) {
									echo 'background-color: #6EC7E6;';
								} elseif ($followUp->inquiry->inquiry_priority == 4) {
									echo 'background-color: #F2B776;';
								}
								?>"></div>
						</td>
						<td style="padding: .35rem 0.5rem !important; border-color: #e4e4e4; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd;">
							<?= "TA-" . $followUp->inquiry->inquiry_id; ?>
						</td>
						<td style="padding: .35rem 0.5rem !important; border-color: #e4e4e4; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd;">
						...
						<td style="padding: .35rem 0.5rem !important; border-color: #e4e4e4; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd;">
							<?= $followUp->inquiry->destination; ?>
						</td>
						<td style="padding: .35rem 0.5rem !important; border-color: #e4e4e4; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd;">
							<?= $followUp->inquiry->date_with_days; ?><!--Oct-29-2016 (3 Nights)-->
						</td>
						<td style="padding: .35rem 0.5rem !important; border-color: #e4e4e4; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd;">
							<?= $followUp->inquiry->mobile; ?>
						</td>
						<td style="padding: .35rem 0.5rem !important; border-color: #e4e4e4; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd;">
							<?php if($followUp->inquiry->followUpHead != '')
                                echo $followUp->inquiry->followUpHead->username;
                            else
                                echo '(not set)';
                            ?>
						</td>
						<td style="padding: .35rem 0.5rem !important; border-color: #e4e4e4; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd;">
							<?= date('d M y h:m a', $followUp->created_at); ?><!--27 October 2016 11:39 AM-->
						</td>
					</tr>
				<?php } ?>
			</tbody>
