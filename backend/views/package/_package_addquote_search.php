...
<div class="card-block margin-less ">
    <div class="row ">
        ...
        &nbsp;&nbsp; &nbsp;&nbsp; <a id="excelsearchbtn" class="btn btn-icon-icon btn-success pull-right"><i class="fa fa-arrow-down"></i></a>
    ...
    <div class="card bg-white">
        ...
        <div class="card-block">
            ...
            <div class="row">
                ...
                <div class="col-md-3 ">
                    <?= $form->field($model, 'no_of_days_nights')->dropDownList(range(0, 15),['prompt'=>'Select No of Nights'])->label(false) ?>
                </div>
                <div class="col-md-3 ">
                    <?= Select2::widget([
                        'model'=> $model,
            ...
            <div class="row">
                <div class="col-sm-2 pull-right">
                    <?= Html::Button('Search', ['class' => 'btn btn-primary ','id'=>'addquotesearchbtn']) ?>
