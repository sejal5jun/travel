            ...
            <div class="card-block">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <?= Html::textInput('RecordInquirySearch[start_date]', '', ['id' => 'start_date', 'class' => 'form-control resetsearch', 'data-provide' => 'datepicker', 'data-date-format' => 'M-dd-yyyy']) ?>
                    </div>
                   <div class="col-sm-3">
                        <label class="control-label">End Date</label>
                        <?= Html::textInput('RecordInquirySearch[end_date]', '', ['id' => 'end_date', 'class' => 'form-control resetsearch', 'data-provide' => 'datepicker', 'data-date-format' => 'M-dd-yyyy']) ?>
                    </div>
