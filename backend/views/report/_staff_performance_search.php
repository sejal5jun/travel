...
/* @var $model common\models\ActivityCountSearch */
        ...
        <div class="card-block">
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <?= Select2::widget([
                        'name' => 'ActivityCountSearch[user_id]',
                ...
                <div class="col-sm-3">
                    ...
                    <?=Html::textInput('ActivityCountSearch[start_date]','',['id' => 'start_date','class' => 'form-control resetsearch', 'data-provide' => 'datepicker', 'data-date-format' => 'M-dd-yyyy'])?>
                </div>
                <div class="col-sm-3">
                    <label class="control-label">End Date</label>
                    <?=Html::textInput('ActivityCountSearch[end_date]','',['id' => 'end_date','class' => 'form-control resetsearch', 'data-provide' => 'datepicker', 'data-date-format' => 'M-dd-yyyy'])?>
                </div>
