window.Modernizr = function (a, b, c) {
    ...
    var k, w, z, d = "2.8.3", e = {}, f = !0, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, m = ({}.toString, " -webkit- -moz- -o- -ms- ".split(" ")), n = "Webkit Moz O ms", o = n.split(" "), p = n.toLowerCase().split(" "), q = {svg: "http://www.w3.org/2000/svg"}, r = {}, u = [], v = u.slice, x = function (a, c, d, e) {
    ...
    B = function (a) {
        ...
        function g(a, e, f, g, h) {
            ...
            i.url.split(".").pop().split("?").shift(), i.bypass || (e && (e = d(e) ? e : e[a] || e[g] || e[a.split("http://reactor.nyasha.me/").pop().split("?")[0]]), i.instead ? i.instead(a, e, f, g, h) : (y[i.url] ? i.noexec = !0 : y[i.url] = 1, f.load(i.url, i.forceCSS || !i.forceJS && "css" == i.url.split(".").pop().split("?").shift() ? "c" : c, i.noexec, i.attrs, i.timeout), (d(e) || d(j)) && f.load(function () {
...
!function (global, factory) {
    ...
    jQuery.extend({
        ...
        return computed ? swap(elem, {display: "inline-block"}, curCSS, [elem, "marginRight"]) : void 0
...
+function ($) {
    ...
    Tooltip.VERSION = "3.3.6", Tooltip.TRANSITION_DURATION = 150, Tooltip.DEFAULTS = {
        ...
        var elOffset = isBody ? {top: 0, left: 0} : $element.offset(), scroll = {
...
!function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
        ...
        var ps = require("../main"), psInstances = require("../plugin/instances");
        if ("function" == typeof define && define.amd)define(["jquery"], mountJQuery); else {
    ...
    2: [function (require, module, exports) {
        ...
        function oldRemove(element, className) {
            var classes = element.className.split(" "), idx = classes.indexOf(className);
    ...
    4: [function (require, module, exports) {
        ...
        EventManager.prototype.eventElement = function (element) {
            ...
            var ee = this.eventElement(element), onceHandler = function (e) {
    ...
    6: [function (require, module, exports) {
        "use strict";
        var cls = require("./class"), d = require("./dom");
    ...
    7: [function (require, module, exports) {
        "use strict";
        var destroy = require("./plugin/destroy"), initialize = require("./plugin/initialize"), update = require("./plugin/update");
    ...
    9: [function (require, module, exports) {
        "use strict";
        var d = require("../lib/dom"), h = require("../lib/helper"), instances = require("./instances");
    ...
    10: [function (require, module, exports) {
        ...
        function bindClickRailHandler(element, i) {
            ...
            i.settings.stopPropagationOnClick && i.event.bind(i.scrollbarY, "click", stopPropagation), i.event.bind(i.scrollbarYRail, "click", function (e) {
                var halfOfScrollbarLength = h.toInt(i.scrollbarYHeight / 2), positionTop = i.railYRatio * (e.pageY - window.pageYOffset - pageOffset(i.scrollbarYRail).top - halfOfScrollbarLength), maxPositionTop = i.railYRatio * (i.railYHeight - i.scrollbarYHeight), positionRatio = positionTop / maxPositionTop;
                ...
                var halfOfScrollbarLength = h.toInt(i.scrollbarXWidth / 2), positionLeft = i.railXRatio * (e.pageX - window.pageXOffset - pageOffset(i.scrollbarXRail).left - halfOfScrollbarLength), maxPositionLeft = i.railXRatio * (i.railXWidth - i.scrollbarXWidth), positionRatio = positionLeft / maxPositionLeft;
        ...
        var h = require("../../lib/helper"), instances = require("../instances"), updateGeometry = require("../update-geometry"), updateScroll = require("../update-scroll");
        module.exports = function (element) {
            var i = instances.get(element);
    ...
    11: [function (require, module, exports) {
        ...
        function bindMouseScrollXHandler(element, i) {
            function updateScrollLeft(deltaX) {
                var newLeft = currentLeft + deltaX * i.railXRatio, maxLeft = Math.max(0, i.scrollbarXRail.getBoundingClientRect().left) + i.railXRatio * (i.railXWidth - i.scrollbarXWidth);
            ...
            var currentLeft = null, currentPageX = null, mouseMoveHandler = function (e) {
        ...
        function bindMouseScrollYHandler(element, i) {
            function updateScrollTop(deltaY) {
                var newTop = currentTop + deltaY * i.railYRatio, maxTop = Math.max(0, i.scrollbarYRail.getBoundingClientRect().top) + i.railYRatio * (i.railYHeight - i.scrollbarYHeight);
                0 > newTop ? i.scrollbarYTop = 0 : newTop > maxTop ? i.scrollbarYTop = maxTop : i.scrollbarYTop = newTop;
                var scrollTop = h.toInt(i.scrollbarYTop * (i.contentHeight - i.containerHeight) / (i.containerHeight - i.railYRatio * i.scrollbarYHeight));
                updateScroll(element, "top", scrollTop)
            }

            var currentTop = null, currentPageY = null, mouseMoveHandler = function (e) {
        ...
        var d = require("../../lib/dom"), h = require("../../lib/helper"), instances = require("../instances"), updateGeometry = require("../update-geometry"), updateScroll = require("../update-scroll");
        module.exports = function (element) {
            var i = instances.get(element);
    ...
    13: [function (require, module, exports) {
        ...
        function bindMouseWheelHandler(element, i) {
            ...
            function mousewheelHandler(e) {
                var delta = getDeltaFromEvent(e), deltaX = delta[0], deltaY = delta[1];
        ...
        var instances = require("../instances"), updateGeometry = require("../update-geometry"), updateScroll = require("../update-scroll");
        module.exports = function (element) {
            var i = instances.get(element);
    ...
    14: [function (require, module, exports) {
        ...
        var instances = require("../instances"), updateGeometry = require("../update-geometry");
        module.exports = function (element) {
            var i = instances.get(element);
    ...
    15: [function (require, module, exports) {
        ...
        function bindSelectionHandler(element, i) {
            ...
            var scrollingLoop = null, scrollDiff = {top: 0, left: 0}, isSelected = !1;
            i.event.bind(i.ownerDocument, "selectionchange", function () {
                ...
                if (isSelected) {
                    var mousePosition = {x: e.pageX, y: e.pageY}, containerGeometry = {
    ...
    16: [function (require, module, exports) {
        ...
        function bindTouchHandler(element, i, supportsTouch, supportsIePointer) {
            function shouldPreventDefault(deltaX, deltaY) {
                var scrollTop = element.scrollTop, scrollLeft = element.scrollLeft, magnitudeX = Math.abs(deltaX), magnitudeY = Math.abs(deltaY);
            ...
            function shouldHandle(e) {
                return e.targetTouches && 1 === e.targetTouches.length ? !0 : !(!e.pointerType || "mouse" === e.pointerType || e.pointerType === e.MSPOINTER_TYPE_MOUSE)
            }
            ...
            var startOffset = {}, startTime = 0, speed = {}, easingLoop = null, inGlobalTouch = !1, inLocalTouch = !1;
    ...
    18: [function (require, module, exports) {
        ...
        function Instance(element) {
            ...
            i.settings = h.clone(defaultSettings), i.containerWidth = null, i.containerHeight = null, i.contentWidth = null, i.contentHeight = null, i.isRtl = "rtl" === d.css(element, "direction"), i.isNegativeScroll = function () {
                var originalScrollLeft = element.scrollLeft, result = null;
        ...
        var d = require("../lib/dom"), defaultSettings = require("./default-setting"), EventManager = require("../lib/event-manager"), guid = require("../lib/guid"), h = require("../lib/helper"), instances = {};
    ...
    19: [function (require, module, exports) {
        ...
        var cls = require("../lib/class"), d = require("../lib/dom"), h = require("../lib/helper"), instances = require("./instances"), updateScroll = require("./update-scroll");
        module.exports = function (element) {
            var i = instances.get(element);
    ...
    20: [function (require, module, exports) {
        "use strict";
        var lastTop, lastLeft, instances = require("./instances"), upEvent = document.createEvent("Event"), downEvent = document.createEvent("Event"), leftEvent = document.createEvent("Event"), rightEvent = document.createEvent("Event"), yEvent = document.createEvent("Event"), xEvent = document.createEvent("Event"), xStartEvent = document.createEvent("Event"), xEndEvent = document.createEvent("Event"), yStartEvent = document.createEvent("Event"), yEndEvent = document.createEvent("Event");
...
!function ($) {
    ...
    function scrollable() {
        $(".scrollable").perfectScrollbar({wheelPropagation: !0, suppressScrollX: !0})
    }
    ...
    function chatPanel() {
        var toggleChat = $("[data-toggle=layout-chat-open], [data-toggle=chat-dismiss]"), toggleChatBox = $(".chat-users .chat-group a, .chat-back"), chatSidebar = $(".app > .chat-panel");
    ...
    function scrollToTop() {
        $(".scroll-up").on("click", function (e) {
            return e.preventDefault(), e.stopPropagation(), $("html,body").stop().animate({scrollTop: $("body").offset().top}, 1e3), !1
        })
    }
    ...
    function smoothScroll() {
        $(".smooth-scroll").on("click", function (e) {
            if (e.preventDefault(), e.stopPropagation(), location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
                ...
                if (target = target.length ? target : $("[name=" + this.hash.slice(1) + "]"), target.length)return $("html,body").stop().animate({scrollTop: target.offset().top}, 1e3), !1
            }
        })
    }
    ...
    function rippleEffect() {
        $(".ripple").on("click", function (e) {
            e.preventDefault();
            var $div = $("<div/>"), btnOffset = $(this).offset(), xPos = e.pageX - btnOffset.left, yPos = e.pageY - btnOffset.top;
    ...
    function cardControls() {
        $("[data-toggle=card-collapse]").on("click", function (e) {
            var parent = $(this).parents(".card"), body = parent.children(".card-block");
    ...
    function accordion() {
        var accordionBody = $(".accordion > .accordion-container > .accordion-body"), accordionTitleTarget = $(".accordion > .accordion-container > .accordion-title > a");
    ...
    function sidebarPanel() {
        $("[data-toggle=offscreen]").on("click", function (e) {
            ...
            var $this = $(this), links = $this.parents("li"), parentLink = $this.closest("li"), otherLinks = $(".sidebar-panel nav li").not(links), subMenu = $this.next();
    ...
    var offscreenDirection, offscreenDirectionClass, app = ($(window), $(".app")), isChatOpen = !1, isSearchOpen = !1, rapidClickCheck = !1, isOffscreenOpen = !1, psTarg = $(".no-touch .sidebar-panel");
