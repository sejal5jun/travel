...
!function (a) {
    ...
    var Va = a.fullCalendar = {version: "2.7.2", internalApiVersion: 3}, Wa = Va.views = {};
    ...
    var kb = Va.EmitterMixin = {
        ...
        isIgnoringMouse: !1, delayUnignoreMouse: null,
    ...
    ub.mixin({
        rowStructs: null, unrenderEvents: function () {
            ...
            return j.unshift("fc-day-grid-event", "fc-h-event"), a.isStart && (c = this.getEventTimeText(f), c && (l = '<span class="fc-time">' + ca(c) + "</span>")), d = '<span class="fc-title" '+    (f.title=="more" ? ' data-toggle="modal"' : "") + '>' + (ca(f.title || "") || "&nbsp;") + "</span>", '<a class="' + j.join(" ") + '"' + (f.url ? ' href="' + ca(f.url) + '"' : "") + (k ? ' style="' + k + '"' : "") + '><div class="fc-content">' + (this.isRTL ? d + " " + l : l + " " + d) + "</div>" + (h ? '<div class="fc-resizer fc-start-resizer" />' : "") + (i ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
    ...
    var wb = Va.View = xa.extend(kb, lb, {
        ...
        getUnitViewSpec: function (b) {
            var c, d, e;
            if (-1 != a.inArray(b, $a))for (c = this.header.getViewsWithButtons(), a.each(Va.views, function (a) {
                c.push(a)
