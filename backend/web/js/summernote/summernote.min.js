...
!function (a) {
    ...
    var K, L = function () {
        ...
        this.events = {
            ...
            if (p.isImg(c)) {
                ...
                h.name = "clipboard.html", b.invoke("editor.restoreRange"), b.invoke("editor.focus"), b.invoke("editor.insertImagesOrCallback", [h])
            } else {
            ...
            if (c && c.items && c.items.length) {
                ...
                "file" === e.kind && -1 !== e.type.indexOf("image/index.html") && b.invoke("editor.insertImagesOrCallback", [e.getAsFile()]), b.invoke("editor.afterCommand")
            }
        }
    }, W = function (b) {
    ...
    var X = function (a) {
        ...
        var e = this, f = a.summernote.ui, g = b.layoutInfo.toolbar, h = b.options, i = h.langInfo, j = c.invertObject(h.keyMap[m.isMac ? "mac" : "pc"]), k = this.representShortcut = function (a) {
            var b = j[a];
            return m.isMac && (b = b.replace("CMD", "⌘").replace("SHIFT", "⇧")), b = b.replace("BACKSLASH", "\\").replace("SLASH", "http://reactor.nyasha.me/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]"), " (" + b + ")"
        };
        this.initialize = function () {
